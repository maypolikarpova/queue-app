...
public class QueueController {
    ...
    @ApiOperation(value = "Read Queue information", nickname = "readQueue", response = String.class)
    @ApiResponses(value = {
    ...
    public ResponseEntity<Queue> readQueue(@PathVariable("queue-id") String queueId) {
        return queueService.readQueue(queueId)
